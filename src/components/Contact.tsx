        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <Motion variants={fadeUp} className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div><h3 className="font-semibold font-heading">Address</h3><p className="text-foreground-muted text-sm mt-1">H.No 1-8-23/A, Opp Hayagrivachary Ground, Balasamudram Main Road, Hanamkonda, Warangal - 506001</p></div>
            </div>
            <div className="flex items-start gap-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div><h3 className="font-semibold font-heading">Email</h3><p className="text-foreground-muted text-sm mt-1"><a href="mailto:vinodadental22@gmail.com" className="hover:text-primary">vinodadental22@gmail.com</a></p></div>
            </div>
            <div className="flex items-start gap-4">
